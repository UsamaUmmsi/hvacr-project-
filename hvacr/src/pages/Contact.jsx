              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">123 HVAC Street</p>
                    <p className="text-gray-700">City, State 12345</p>
                    <p className="text-gray-500 text-sm">Serving entire metro area</p>
                  </div>
                </div>
            ...
            <div className="bg-secondary/10 rounded-2xl p-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4 text-center">
                  <div className="font-bold text-gray-900">Residential</div>
                  <div className="text-gray-600 text-sm">Homes & Apartments</div>
                </div>
                <div className="bg-white rounded-lg p-4 text-center">
                  <div className="font-bold text-gray-900">Commercial</div>
                  <div className="text-gray-600 text-sm">Offices & Retail</div>
                </div>
                <div className="bg-white rounded-lg p-4 text-center">
                  <div className="font-bold text-gray-900">Industrial</div>
                  <div className="text-gray-600 text-sm">Factories & Warehouses</div>
                </div>
                <div className="bg-white rounded-lg p-4 text-center">
                  <div className="font-bold text-gray-900">Institutional</div>
                  <div className="text-gray-600 text-sm">Hospitals & Schools</div>
                </div>
              </div>
            </div>
          </div>
